...
JNIEXPORT jint JNICALL Java_com_example_reallin_buyapp_jssc_SerialNativeInterface_Count (JNIEnv *, jobject, jint a, jint b) {
    return a + b;
}
/*
 * Get native library version
 */
JNIEXPORT jstring JNICALL Java_com_example_reallin_buyapp_jssc_SerialNativeInterface_getNativeLibraryVersion(JNIEnv *env, jobject object) {
 ...
 */
JNIEXPORT jlong JNICALL Java_com_example_reallin_buyapp_jssc_SerialNativeInterface_openPort(JNIEnv *env, jobject object, jstring portName, jboolean useTIOCEXCL){
